...
class TextSreen extends StatefulWidget {
  const TextSreen({Key? key}) : super(key: key);

  @override
  State<TextSreen> createState() => _TextSreenState();
}

class _TextSreenState extends State<TextSreen> {
  @override
  Widget build(BuildContext context) {
    ...
    ).createShader(Rect.fromLTWH(50, 10, MediaQuery.of(context).size.height * 1,
        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: Text("NAUFAL", textAlign: TextAlign.left)),
            Text(
              "textScaleFactor:2",
              textScaleFactor: 2,
            ),
